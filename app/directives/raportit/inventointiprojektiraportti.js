angular.module('mip.directives').directive('mipInventointiprojektiraportti', ['locale', function(locale) {
    function link(scope) {
        ...
        /*
         * RAPORTIN HAKUEHTOIHIN VALITUT PAIKKAKUNNAT
         */
        scope.raportti.paikkakuntaSelections = [];
        
        /*
         * RAPORTIN HAKUEHTOIHIN VALITTU INVENTOINTIPROJEKTI
         */
        scope.raportti.inventointiprojektiselection = null;
        ...
        scope.kiinteistoValitutKentat = [
            {
                ...
                'editable': true,
                'name': 'inventointipaiva',
                'label': locale.getString('common.Inventory_date')
            }, {
                'editable': true,
                'name': 'kenttapaiva',
                'label': locale.getString('common.Field_date')
            }, {
                'editable': true,
                'name': 'inventoija',
                'label': locale.getString('common.Inventor')
            }
        ];
        ...
        scope.selectReportDisplayName = function(laji) {
            scope.raportti.reportDisplayName = locale.getString('common.Inventory_project_report') + " - " + laji;
        };         
    ...
    return {
        ...
        restrict : 'E',
        link: link,        
        templateUrl: 'directives/raportit/inventointiprojektiraportti.html'        
    };   
}]);