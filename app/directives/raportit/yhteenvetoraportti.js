angular.module('mip.directives').directive('mipYhteenvetoraportti', ['locale', function(locale) {
    function link(scope) {
        ...
        scope.selectReportDisplayName = function(laji) {
            scope.raportti.reportDisplayName = locale.getString('common.Summary_report') + " - " + laji;
        };
    ...
    return {
        ...
        restrict : 'E',
        link: link,        
        templateUrl: 'directives/raportit/yhteenvetoraportti.html'        
    };   
}]);