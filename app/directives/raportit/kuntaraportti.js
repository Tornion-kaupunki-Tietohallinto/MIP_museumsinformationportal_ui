angular.module('mip.directives').directive('mipKuntaraportti', ['locale', function(locale) {
    function link(scope) {
        ...
        scope.selectReportDisplayName = function(laji) {
            scope.raportti.reportDisplayName = locale.getString('common.County_list_report') + " - " + laji;
        };
    ...
    return {
        ...
        restrict : 'E',
        link: link,        
        templateUrl: 'directives/raportit/kuntaraportti.html'        
    };   
}]);