		...
		[
			...
			function ($scope, $rootScope, TabService, $location, $filter,
                ...
                vm.lisaaKuva = function() {
                    ModalService.arkImageUploadModal("rontgenkuva", vm.xray, false, vm.tutkimusId)
                }
                ...
                vm.openImage = function (image) {
                    ModalService.arkImageModal(image, 'rontgenkuva', vm.xray, vm.permissions, vm.images, null);
                };
                /*
                 * Kartat
                 */
