...
angular.module('mip.tutkimus').controller(
        ...
        [
                '$scope', '$rootScope', '$location', '$filter', 'TutkimusService', 'CONFIG', 'AlertService', 'ModalService', 'ListService', 'locale', 'tutkimus', '$timeout', 'UserService', 'NgTableParams', 'selectedModalNameId',
                'ModalControllerService',
                function($scope, $rootScope, $location, $filter, TutkimusService, CONFIG, AlertService, ModalService, ListService, locale, tutkimus, $timeout, UserService, NgTableParams, selectedModalNameId, ModalControllerService) {
                    var vm = this;
                    /**
                    ...
                    vm.addUser = function() {
                        ...
                        for (var i = 0; i < vm.tutkimus.properties.tutkimuskayttajat.length; i++) {
                            if (vm.tutkimus.properties.tutkimuskayttajat[i].kayttaja.id === vm.selectedUser.user.properties.id) {
                                addUser = false;
                                break;
                            }
                        }
