angular.module('mip.map').factory('MapService', [
		'$rootScope', '$http', '$q', 'KiinteistoService', 'RakennusService', 'CONFIG', 'AlueService', 'ArvoalueService', 'PorrashuoneService', 'locale', 'CacheFactory', 'AlertService', 'ListService', 'FeatureStyleService',
		function($rootScope, $http, $q, KiinteistoService, RakennusService, CONFIG, AlueService, ArvoalueService, PorrashuoneService, locale, CacheFactory, AlertService, ListService, FeatureStyleService) {
...
/*
                ...
                showKohteet : function(mapLayers, searchObj) {
                    var layer = {
                        name : 'Kohteet',
                        active : true,
                ...
                showTutkimusalueet : function(mapLayers, searchObj) {
                    var layer = {
                        name : 'Tutkimusalueet',
                        active : true,
