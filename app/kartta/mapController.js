...
angular.module('mip.map').controller(
        ...
        [
                ...
                'EntityBrowserService', '$filter', 'SuunnittelijaService', 'AlertService', 'KylaService',
                function($scope, TabService, $location, KiinteistoService, ModalService, KuntaService, CONFIG, $compile, olData, RakennusService, MapService,
                    ...
                    $scope.paginators = [
                            $scope.kiinteistoPages, $scope.rakennusPages, $scope.aluePages, $scope.arvoaluePages
                    ];
                    // The default values
