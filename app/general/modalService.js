...
angular.module('mip.general').factory(
        ...
        [
                ...
                'KylaService',
                'PorrashuoneService',
                'SuunnittelijaService',
                'YksikkoService',
                'Auth',
                'AlertService',
                'locale',
                '$timeout',
                'InventointijulkaisuService',
                'MatkaraporttiService',
                'ModalServiceExtension',
                'ModalServiceArkExtension',
                function($rootScope, $modal, CONFIG, KuntaService, KiinteistoService, RakennusService, AlueService, ArvoalueService, InventointiprojektiService, UserService, KylaService, PorrashuoneService, SuunnittelijaService,
                        YksikkoService, Auth, AlertService, locale, $timeout, InventointijulkaisuService, MatkaraporttiService, ModalServiceExtension, ModalServiceArkExtension) {
